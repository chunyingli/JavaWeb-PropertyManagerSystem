...
<%
	String PageTitle="分部查看工程页面";
	String zongbunav="";
	String fenbunav="active";
	String zidanwei="";
	String personal="";
  ...
  //查询数据，追加到表格中
   function loaddata(){
                 ...
                 if (result.isSuccess==false) {
                    alert('发生了错误！');
                 	...
                 	for(var i=0,len=result.length;i<len;i++)
                 	{
                 		...
                 		'</td><td><a href="BranchViewProject.jsp?ProjectNo='+result[i].projectNo+'">详情</a></td></tr>')
                 	}	
                 }
     ...
     $("#chooseValue").change(function(){
     	location.href="BranchQueryProject.jsp?Page="+page+"&chooseValue="+$("#chooseValue").val();
     })
</script>
